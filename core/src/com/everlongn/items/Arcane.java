...
public class Arcane extends Weapon {
    ...
    public static Arcane arcaneCaster = new Arcane(Items.arcaneCasterR, "Arcane Caster", 201, false, true, 100, 100, 1, "Power beyond your understanding...",
            52, 58, new TextureRegion[]{Items.arcaneCasterL, Items.arcaneCasterR}, new String[]{"Arcane"}, 10, 0.6f, 0);

    public static Arcane arcaneEruption = new Arcane(Items.arcaneEruptionR, "Arcane Eruption", 202, false, true, 108, 108, 1, "Power beyond your understanding...",
