...
public class Melee extends Weapon {
    ...
    public static Melee dragondance = new Melee(Items.dragonDanceR, "Dragondance", 202, false, false, 150, 150,
    ...
    public Melee(TextureRegion texture, String name, int id, boolean stackable, boolean degeneratable, int width, int height, int capacity, String description, float holdX, float holdY, TextureRegion[] display, String[] elemental,
    ...
    public Melee createNew(int count) {
        Melee i = new Melee(texture, name, id, stackable, degeneratable, width, height, capacity, description, holdX, holdY, display, elemental, damage, drawSpeed, swingSpeed, critChance, force, heavy);
        i.pickedUp = true;
        i.count = count;
        return i;
    }
